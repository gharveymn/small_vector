...
void
graphs::new_graph (const std::string& graph_name, const std::string& graph_title,
...
void
graphs::new_result (const std::string& serie, const std::string& group, std::size_t value)
{
